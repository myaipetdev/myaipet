      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18, marginTop: 18 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.12)",
          }}>
          ...
          return (
            <div key={c.chain} style={{
              ...
              <div style={{
                ...
                <span style={{ fontFamily: "mono", fontSize: 12, color: "white", fontWeight: 600 }}>
                  {displayName}
                </span>
              ...
              <div style={{ fontFamily: "mono", fontSize: 10, color: "rgba(255,255,255,0.2)", marginTop: 6 }}>

      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
          <div style={{
            ...
            boxShadow: "0 0 10px rgba(22,163,74,0.4)", animation: "pulse 2s infinite",
          }} />
          <span style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{
                  ...
                  color: a.chain === "Base" ? "#3b82f6" : "#b45309",
                  fontFamily: "mono", fontWeight: 500,
                }}>
                  {a.chain}
                </span>
              </div>
              <span style={{ fontFamily: "mono", fontSize: 11, color: "rgba(26,26,46,0.5)" }}>
                {a.text}
              </span>
            </div>
            <span style={{
              fontFamily: "mono", fontSize: 10, color: "rgba(26,26,46,0.3)", whiteSpace: "nowrap",
            }}>
              {a.time}
            </span>
          </div>

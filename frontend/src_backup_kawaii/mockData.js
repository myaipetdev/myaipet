 ...
 * All wallet addresses use valid hex (0-9, a-f) only.
 * Stats are fixed values to prevent random changes on refresh.
 */
...
export const MOCK_ACTIVITIES = [
  ...
  { icon: "🐕", wallet: "0x5e6f...a8b2", chain: "BNB", text: "Adopted a new pet: Mochi the Dog", time: "45s ago" },
  { icon: "❤️", wallet: "0x9a0b...1c2d", chain: "Base", text: "Liked 'Noodle in Space' by CryptoKitty", time: "1m ago" },
  { icon: "🎨", wallet: "0x3e4f...5a6b", chain: "Base", text: "Generated watercolor art of Pixel the Fox", time: "2m ago" },
  { icon: "💬", wallet: "0x7c8d...9e0f", chain: "BNB", text: "Commented on 'Storm's Adventure'", time: "3m ago" },
  ...
  { icon: "🐱", wallet: "0xde90...fc12", chain: "Base", text: "Adopted a new pet: Tofu the Cat", time: "7m ago" },
  { icon: "🔥", wallet: "0xba34...dc56", chain: "BNB", text: "Burned 50 $PET tokens", time: "8m ago" },
  { icon: "❤️", wallet: "0xfe78...ad90", chain: "Base", text: "Liked 'Mango's Tea Party'", time: "10m ago" },
];
...
// Seeded pseudo-random for stable values across refreshes
...
export const MOCK_SOCIAL_FEED = {
  items: Array.from({ length: 24 }, (_, i) => ({
    ...
    likes_count: stableInt(i * 7 + 3, 12, 480),
    comments_count: stableInt(i * 11 + 5, 0, 24),
    is_liked: i % 3 === 0,
    duration: [3, 5, 10][i % 3],

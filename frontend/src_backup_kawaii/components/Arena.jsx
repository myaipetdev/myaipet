  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ fontFamily: "mono", fontSize: 13, color: "rgba(255,255,255,0.5)", marginBottom: 4 }}>
        ...
        <button onClick={onClose} style={{
          ...
          fontFamily: "'Space Grotesk',sans-serif", fontSize: 13, color: "white", fontWeight: 500,
        }}>
          Play Again
        </button>
      </div>
    ...
    <div style={{ padding: "0 24px 60px", maxWidth: 1200, margin: "0 auto", paddingTop: 90 }}>
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 24 }}>
        ...
        <span style={{
          ...
          border: "1px solid rgba(251,191,36,0.15)", fontWeight: 600,
        }}>
          BNB / USDT
        </span>
        <span style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 16, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{
            ...
            <div style={{ padding: "18px 22px 0", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                ...
                <div style={{ fontFamily: "mono", fontSize: 10, color: "rgba(255,255,255,0.2)", marginTop: 2 }}>
                  BNB/USDT · Live
                </div>
              </div>
              <div style={{ display: "flex", gap: 6 }}>
                {["1m", "5m", "15m", "1h"].map(t => (
                  <span key={t} style={{
                    ...
                    background: t === "5m" ? "rgba(255,255,255,0.06)" : "transparent",
                    color: t === "5m" ? "rgba(255,255,255,0.6)" : "rgba(255,255,255,0.15)",
                    cursor: "pointer",
                  }}>{t}</span>
                ))}
              </div>
          ...
          <div style={{
            background: "rgba(255,255,255,0.015)", borderRadius: 16,
            border: "1px solid rgba(255,255,255,0.04)", padding: "18px 22px",
          }}>
            {/* Balance + Stats */}
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                <div>
                  <div style={{ fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: 2 }}>Balance</div>
                  <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 18, fontWeight: 700, color: "#fbbf24" }}>
                    {balance.toFixed(0)} $PET
                  </div>
                </div>
                <div style={{ width: 1, height: 28, background: "rgba(255,255,255,0.05)" }} />
                <div>
                  <div style={{ fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: 2 }}>Win Rate</div>
                ...
                <div style={{ width: 1, height: 28, background: "rgba(255,255,255,0.05)" }} />
                <div>
                  <div style={{ fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: 2 }}>Record</div>
                  <div style={{ fontFamily: "mono", fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.5)" }}>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: 8 }}>
                Bet Amount
              </div>
              <div style={{ display: "flex", gap: 6 }}>
                {[5, 10, 25, 50, 100].map(amt => (
                  <button key={amt} onClick={() => !betActive && setBetAmount(amt)}
                    ...
                    style={{
                      ...
                      background: betAmount === amt ? "rgba(251,191,36,0.1)" : "rgba(255,255,255,0.02)",
                      border: betAmount === amt ? "1px solid rgba(251,191,36,0.25)" : "1px solid rgba(255,255,255,0.04)",
                      fontFamily: "mono", fontSize: 12, fontWeight: 600,
                      color: balance < amt ? "rgba(255,255,255,0.1)" : betAmount === amt ? "#fde68a" : "rgba(255,255,255,0.3)",
                      transition: "all 0.2s",
                    }}>
                    {amt}
                  </button>
            ...
            {betActive ? (
              <div style={{ textAlign: "center", padding: "12px 0" }}>
                <div style={{
                  fontFamily: "'Space Grotesk',sans-serif", fontSize: 14, color: "rgba(255,255,255,0.4)",
                  marginBottom: 8,
                }}>
                ...
                <div style={{
                  ...
                  color: countdown <= 3 ? "#f87171" : "white",
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button onClick={() => placeBet("up")} style={{
                  ...
                  <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 15, fontWeight: 700, color: "#4ade80" }}>
                    LONG
                  </span>
                  <span style={{ fontFamily: "mono", fontSize: 9, color: "rgba(74,222,128,0.5)" }}>
                    1.85x payout
                  </span>
                </button>
                <button onClick={() => placeBet("down")} style={{
                  ...
                  <span style={{ fontSize: 24 }}>📉</span>
                  <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 15, fontWeight: 700, color: "#f87171" }}>
                    SHORT
                  </span>
                  <span style={{ fontFamily: "mono", fontSize: 9, color: "rgba(248,113,113,0.5)" }}>
                    1.85x payout
                  </span>
                </button>
              </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <div>
                <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 15, fontWeight: 600, color: "white" }}>
                  {pet.name}
                </div>
            ...
            {currentBehavior && (
              <div style={{
                ...
                background: currentBehavior.signal === "bullish"
                  ? "rgba(74,222,128,0.04)" : currentBehavior.signal === "bearish"
                  ? "rgba(248,113,113,0.04)" : "rgba(255,255,255,0.02)",
                border: currentBehavior.signal === "bullish"
                  ? "1px solid rgba(74,222,128,0.12)" : currentBehavior.signal === "bearish"
                  ? "1px solid rgba(248,113,113,0.12)" : "1px solid rgba(255,255,255,0.04)",
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <span style={{
                    ...
                    background: currentBehavior.signal === "bullish"
                      ...
                      ? "rgba(248,113,113,0.1)" : "rgba(255,255,255,0.04)",
                    color: currentBehavior.signal === "bullish"
                      ? "#4ade80" : currentBehavior.signal === "bearish"
            ...
            {/* Behavior history */}
            <div>
              <div style={{ fontFamily: "mono", fontSize: 9, color: "rgba(255,255,255,0.15)", textTransform: "uppercase", marginBottom: 8 }}>
                Signal History
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                {behaviorHistory.slice(0, 5).map((b, i) => (
                  <div key={i} style={{
                    ...
                    borderRadius: 6, background: i === 0 ? "rgba(255,255,255,0.02)" : "transparent",
                    opacity: 1 - i * 0.15,
                  }}>
                    <span style={{ fontSize: 12 }}>{b.emoji}</span>
                    <span style={{
                      flex: 1, fontFamily: "mono", fontSize: 10, color: "rgba(255,255,255,0.3)",
                    ...
                    <span style={{
                      ...
                      background: b.signal === "bullish" ? "#4ade80" : b.signal === "bearish" ? "#f87171" : "rgba(255,255,255,0.15)",
                    }} />
                  </div>
                ))}
              </div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 14, fontWeight: 600, color: "white" }}>
                  Leaderboard
                </span>
              </div>
              <div style={{ display: "flex", gap: 2 }}>
                {["daily", "weekly", "all"].map(t => (
                  <button key={t} onClick={() => setLeaderboardTab(t)} style={{
                    background: leaderboardTab === t ? "rgba(255,255,255,0.06)" : "transparent",
                    border: "none", borderRadius: 6, padding: "3px 8px",
                    fontFamily: "mono", fontSize: 9, cursor: "pointer",
                    color: leaderboardTab === t ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.2)",
              ...
              {MOCK_LEADERBOARD.map((entry, i) => (
                <div key={i} style={{
                  ...
                  <span style={{
                    ...
                    color: i === 0 ? "#fbbf24" : i === 1 ? "#c0c0c0" : i === 2 ? "#cd7f32" : "rgba(255,255,255,0.15)",
            ...
            <div style={{
              ...
              <span style={{ fontFamily: "mono", fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.2)", width: 18, textAlign: "center" }}>
                42
              </span>
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 12, fontWeight: 600, color: "#fbbf24" }}>
                  You
                </div>

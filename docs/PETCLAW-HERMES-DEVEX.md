...
Comparison baseline: Hermes Agent `v0.18.2` (`v2026.7.7.2`); PetClaw SDK `2.0.0`
...
|---|---|---|---|
| Install | Full agent runtime | One npm SDK/CLI/MCP package | npm must report `2.0.0+` |
...
- public documentation names SDK `2.0.0` only after npm serves that exact

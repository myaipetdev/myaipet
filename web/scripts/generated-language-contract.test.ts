...
const requiredBoundaries: Array<[string, string[]]> = [
  ...
  ["src/app/api/pet-date/route.ts", ["containsHangul"]],
  ...
  ["src/lib/petclaw/memory/daydream.ts", ["generatedEnglishOrNull", "containsHangul"]],
  ["src/lib/petclaw/memory/persistent-memory.ts", ["containsHangul(parsed)"]],
  ["src/lib/petclaw/memory/bond-loop.ts", ["generatedEnglishOrNull", "containsHangul"]],

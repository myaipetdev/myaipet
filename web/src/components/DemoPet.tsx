...
export default function DemoPet({ cta, ctaNote }: { cta?: ReactNode; ctaNote?: string }) {
  ...
  return (
    <div style={{ maxWidth: 460, margin: "0 auto", padding: "120px 20px 48px", textAlign: "center" }}>
      ...
      <div style={{ fontFamily: "var(--ed-m)", fontSize: 13, letterSpacing: "0.14em", color: "#9A4E1E", fontWeight: 700, marginBottom: 6, textTransform: "uppercase" }}>
      ...
      <div style={{ maxWidth: 320, margin: "0 auto 18px", display: "flex", flexDirection: "column", gap: 7 }}>
        {([
          ...
          <div key={row.k}>
            <div style={{ display: "flex", justifyContent: "space-between", fontFamily: "var(--ed-m)", fontSize: 13, color: "#7A6E5A", marginBottom: 3 }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: "var(--ed-m)", fontSize: 13, color: "#9A4E1E", letterSpacing: "0.12em", marginBottom: memory.length ? 4 : 0, textTransform: "uppercase" }}>
        ...
        {memory.length === 0 ? (
          ...
          <div key={i} style={{ fontFamily: "var(--ed-body)", fontSize: 13, color: "#5C5140", opacity: 1 - i * 0.3 }}>· {m}</div>
        ))}
      </div>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: "var(--ed-body)", fontSize: 13, color: "rgba(255,248,238,0.7)", marginBottom: 14 }}>

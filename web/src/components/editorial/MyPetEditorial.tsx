    ...
    <div style={{ marginTop: 16, position: "relative" }}>
      {pop && (
        <span key={pop.id} aria-hidden style={{
          position: "absolute", right: 0, top: -8, fontFamily: T.m, fontSize: 12, fontWeight: 700,
        ...
        <div className="mp-grid" style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: 24, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div className="ed-rise" style={{ ...rise(3), position: "relative", background: T.paper, border: `1px solid ${T.hair}`, borderRadius: 12, padding: "9px 12px" }}>
                {pops.experience && (
                  <span key={pops.experience.id} aria-hidden style={{
                    position: "absolute", right: 12, top: -8, fontFamily: T.m, fontSize: 12, fontWeight: 700,
            ...
            <div className="ed-rise" style={{ ...rise(4), background: T.paper, borderRadius: 22, padding: 20, boxShadow: "var(--ed-shadow-card)" }}>
              ...
              {statusMeta.hint && (
                <div style={{ marginTop: 4, fontSize: 12, color: T.muted2 }}>{statusMeta.hint}</div>
              )}

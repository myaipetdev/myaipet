      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 13, fontFamily: "var(--ed-m)", letterSpacing: "0.14em", color: "rgba(255,248,238,0.55)" }}>
              YOUR SEASON
            </div>
...
function Tile({ label, value, accent, sub }: { label: string; value: React.ReactNode; accent: string; sub?: string }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, fontFamily: "var(--ed-m)", letterSpacing: "0.12em", color: "rgba(255,248,238,0.6)" }}>
        {label}
      </div>
      <div style={{ fontSize: 22, fontWeight: 800, color: accent, fontFamily: "var(--ed-m)", lineHeight: 1.1, marginTop: 2 }}>
        {value}
      </div>
      {sub && <div style={{ fontSize: 13, color: "rgba(255,248,238,0.6)", marginTop: 1 }}>{sub}</div>}
    </div>
  );
}

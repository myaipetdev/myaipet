...
.thumbstudio-root .ts-eyebrow{font-family:var(--ed-m);font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:${T.terraSub}}
...
.thumbstudio-root .ts-freebadge{display:inline-block;font-family:var(--ed-m);font-size:12px;font-weight:700;letter-spacing:.04em;color:${T.terra};background:rgba(190,79,40,.10);border:1px solid rgba(190,79,40,.2);border-radius:999px;padding:2px 9px;margin-left:4px;white-space:nowrap}
...
.thumbstudio-root .ts-meter{font-family:var(--ed-m);font-size:12px;font-weight:700;letter-spacing:.03em;color:${T.muted2};background:${T.inset};border:1px solid ${T.hair};border-radius:999px;padding:5px 11px}
...
.thumbstudio-root .ts-note{margin:0;font-size:12px;color:${T.muted};line-height:1.45}
...
.thumbstudio-root .ts-panel-label{font-family:var(--ed-m);font-size:12px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:${T.mono};margin-bottom:10px}
...
.thumbstudio-root .ts-chip{min-height:34px;padding:5px 12px;border:1px solid rgba(190,79,40,.3);border-radius:999px;background:rgba(190,79,40,.08);color:${T.terra};font-family:var(--ed-m);font-size:12px;font-weight:700;letter-spacing:.04em;cursor:pointer;white-space:nowrap}
...
.thumbstudio-root .ts-style-txt span{font-size:12px;color:${T.muted};line-height:1.25}

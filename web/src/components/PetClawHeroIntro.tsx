...
const CHIPS: Array<{ label: string; mark: string; x: number; y: number; d: number }> = [
  ...
  { label: `mcp · sdk ${RELEASE_STATUS.sdkVersion}`, mark: "◈", x: 196, y: 186, d: 7.25 },
];
  ...
  return (
    <div ref={stageRef} className="pchi-stage" aria-label={`PetClaw — ${petName}'s agent booting`}>
      <style>{`
        ...
        .pchi-wm .pchi-wm-sub{margin-top:4px;font-size:13px;color:rgba(251,246,236,.62)}
        ...
        .pchi-seal{position:absolute;top:-11px;right:-11px;width:38px;height:38px;border-radius:50%;
          ...
          color:#3d2708;font-family:var(--ed-m);font-weight:800;font-size:13px;box-shadow:0 6px 14px -6px rgba(0,0,0,.7)}
        ...
        .pchi-chip{position:absolute;left:50%;top:40%;transform:translate(-50%,-50%) scale(.2);opacity:0;z-index:4;
          --x:var(--xs);--y:var(--ys);
          font-family:var(--ed-m);font-size:13px;font-weight:700;letter-spacing:.08em;padding:7px 13px;border-radius:999px;
          ...
          <div className="pchi-lid">
            <div className="pchi-screen">
              ...
              <div className="pchi-term">
                ...
                <span className="pchi-ln l2">protocol v1 · SDK {RELEASE_STATUS.sdkVersion} contract</span>

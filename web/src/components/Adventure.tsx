    ...
    <div style={{ width: "100%", position: "relative" }}>
      {showLabel && (
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 2 }}>
          <span style={{ fontSize: 13, color: "#666", fontWeight: 600 }}>{Math.round(value)}/{max}</span>
        </div>
      )}
      <div style={{
...
function RpgButton({ onClick, disabled, emoji, label, desc, color, index = 0 }: {
  ...
  return (
    ...
    >
      ...
      <div style={{
        color: "#555", fontSize: 13, marginTop: 4, letterSpacing: 0.3,
        position: "relative",
      }}>{desc}</div>
    </button>
  );
        ...
        return (
          ...
          >
            ...
            <div style={{
              ...
              color: accent, fontSize: 13, fontWeight: 600, marginBottom: 8,
            }}>Lv.{pet.level}</div>
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 24 }}>
        ...
        <p style={{ color: "#555", fontSize: 13, marginTop: 6, letterSpacing: 0.5 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                padding: "1px 8px", color: "#60a5fa", fontSize: 13, fontWeight: 600,
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 300, margin: "0 auto 20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              <span style={{ fontSize: 13, color: "#555", fontWeight: 600, letterSpacing: 1 }}>EXPLORATION</span>
              <span style={{ fontSize: 13, color: accent, fontWeight: 600 }}>{revealedCount}/3</span>
            </div>
            <div style={{
                ...
                >
                  {isRevealed ? (
                    <>
                      ...
                      <div style={{ color: "#e0e0e0", fontSize: 13, fontWeight: 700, marginBottom: 4 }}>{loc.name}</div>
                      <div style={{ color: "#666", fontSize: 13, marginBottom: 10, lineHeight: 1.3 }}>{loc.desc}</div>
                      <div style={{
                        ...glassCard(lc.accent, {
                          padding: "6px 12px",
                        }),
                        ...
                        <span style={{
                          color: lc.accent, fontSize: 13, fontWeight: 600,
                        }}>{rewards[i]}</span>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div style={{ color: "#333", fontSize: 13, marginTop: 6, letterSpacing: 0.5 }}>Tap to explore</div>
            ...
            >
              ...
              >
                ...
                {hasPets === null && !isInMode ? (
                  ...
                  <div style={{ textAlign: "center", padding: "40px 20px" }}>
                    ...
                    <div style={{ color: "#444", fontSize: 13, letterSpacing: 1, marginTop: 10 }}>Checking your pets...</div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <p style={{
                      color: "#666", fontSize: 13, lineHeight: 1.6, maxWidth: 300,
                      margin: "0 auto 28px",
                    }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {"\u{1F50B}"}
                    <span style={{ fontSize: 13 }}>98%</span>
                  </span>

  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ color: "rgba(26,26,46,0.55)", fontFamily: "'JetBrains Mono', monospace", fontSize: 12 }}>
        ...
        <aside style={{
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 12 }}>
            ...
            {libTab === "history" && (
              history.length === 0 ? (
                <div style={emptyState}>
                  <div style={{ fontSize: 12, color: "rgba(26,26,46,0.55)" }}>No generations yet.</div>
                </div>
              ) : (
                <div style={{ display: "grid", gap: 8 }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "grid", gap: 16 }}>
            ...
            <Field label="MODEL">
              <select value={chosenModelId} onChange={e => setChosenModelId(e.target.value)} style={{
                width: "100%", padding: 8, borderRadius: 8,
                border: "1px solid rgba(0,0,0,0.12)", fontSize: 12, background: "white",
                fontFamily: "'Space Grotesk',sans-serif",
              }}>
                {videoModels.map(m => (

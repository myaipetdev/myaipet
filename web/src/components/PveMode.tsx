      ...
      <div style={{ padding: "0 8px" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontFamily: "var(--ed-m)", fontSize: 13, fontWeight: 700, color: "#C8932F" }}>
              {totalStars}
            </span>
            <span style={{ color: "#555", fontSize: 13 }}>/ 90</span>
          </div>
        </div>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: "#666", fontSize: 13, marginTop: 1 }}>{region.description}</div>
                  </div>
                </div>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
                  <div style={{
                    ...
                    <span style={{ fontFamily: "var(--ed-m)", fontSize: 13, fontWeight: 700, color: region.color }}>
                  ...
                  {region.stages.map((stage, sIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{
                          fontSize: 13, fontWeight: 800, color: stage.unlocked ? "#e8e8e8" : "#333",
                          fontFamily: "var(--ed-disp)",
    ...
    return (
      <div style={{ padding: "0 8px" }}>
        ...
        <button onClick={backToMap} style={{
          ...
          borderRadius: 10, padding: "8px 16px", color: "#888", fontSize: 13, cursor: "pointer",
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", position: "relative" }}>
            ...
            <div style={{
              color: region?.color || "#888", fontSize: 13, fontWeight: 700,
              fontFamily: "var(--ed-disp)",
            ...
            <div style={{
              ...
              <span style={{ fontFamily: "var(--ed-m)", fontSize: 13, color: "#555" }}>HP</span>
              <div style={{
              ...
              <span style={{ fontFamily: "var(--ed-m)", fontSize: 13, color: "#555" }}>FULL</span>
            </div>
        ...
        <div style={{
          color: "#888", fontSize: 13, textAlign: "center", marginBottom: 14, fontWeight: 700,
          fontFamily: "var(--ed-disp)", letterSpacing: 2, textTransform: "uppercase",
        }}>
          Choose Your Fighter
          <span style={{
            display: "block", fontSize: 13, color: "#555", fontWeight: 400, marginTop: 2, letterSpacing: 0,
          }}>
          ...
          {myPets.map((pet) => {
            ...
            return (
              ...
              >
                ...
                <div style={{
                  color: el.color, fontSize: 13, fontFamily: "var(--ed-m)", fontWeight: 700, marginTop: 2,
        ...
        <div style={{
          ...
          <div style={{ position: "relative", width: "100%", aspectRatio: "16/9", minHeight: 200, maxHeight: 320 }}>
            <Suspense fallback={
              <div style={{
                ...
                background: "linear-gradient(180deg, #0a0a18, #060614)", borderRadius: 14, color: "#444", fontSize: 13,
                fontFamily: "var(--ed-disp)",
              ...
              {player.skills.slice(0, 4).map((eq) => {
                ...
                return (
                  <button key={eq.key} onClick={() => activateSkill(eq)} disabled={dis} style={{
                    ...
                    <div style={{
                      fontSize: 13, fontWeight: 800, color: dis ? "#444" : "#e8e8e8",
                      fontFamily: "var(--ed-disp)",
                      whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
                    }}>{s.name}</div>
          ...
          {phase === "battle" && !battleOver && (
            <div style={{ textAlign: "center", padding: "2px 0 14px" }}>
              <span style={{
                fontFamily: "var(--ed-m)",
                fontSize: 13, fontWeight: 800, padding: "4px 16px", borderRadius: 20,
                letterSpacing: 2,
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {SKILL_MAP[resultData.skill_drop] && (
                      <div style={{ fontSize: 13, color: "#888", fontFamily: "var(--ed-m)", marginTop: 4 }}>

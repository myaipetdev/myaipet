    ...
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "104px 20px 56px" }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative" }}>
          <div style={{ fontFamily: "var(--ed-m)", fontSize: 11, letterSpacing: "0.14em", color: "#9A7B4E", marginBottom: 12 }}>
      ...
      <div style={{ marginTop: 16, background: "#F5EFE2", borderRadius: 18, padding: "20px 22px", border: "1px solid var(--ed-hair, rgba(33,26,18,.13))" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
          ...
          <span style={{ fontSize: 9, fontFamily: "var(--ed-m)", fontWeight: 700, letterSpacing: "0.08em", padding: "3px 10px", borderRadius: 999, background: "rgba(26,126,104,0.12)", color: "#1A7E68" }}>LIVE · PUBLIC</span>
          <div style={{ flex: 1 }} />
            ...
            {online.map((n: any) => (
              <div key={n.petId} style={{ display: "flex", alignItems: "center", gap: 12, padding: "9px 12px", borderRadius: 12, background: "#FBF6EC", border: "1px solid var(--ed-hair, rgba(33,26,18,.13))" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontFamily: "var(--ed-m)", fontSize: 11, color: "#7A6E5A", marginTop: 1 }}>
                    {[n.personality, n.element, n.level != null ? `Lv.${n.level}` : null].filter(Boolean).join(" · ")}
                  </div>
                </div>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, padding: "4px 10px", borderRadius: 999, background: "rgba(26,126,104,0.1)", border: "1px solid rgba(26,126,104,0.25)", color: "#1A7E68", fontFamily: "var(--ed-m)", fontWeight: 700 }}>

  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 3 }}>
        ...
        <span style={{
          fontSize: 13, padding: "1px 5px", borderRadius: 8,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 3, marginTop: 3 }}>
        <span style={{ fontFamily: "monospace", fontSize: 13, color: "#666", fontWeight: 700 }}>HP</span>
        <div style={{
      ...
      <div style={{ fontFamily: "monospace", fontSize: 13, color: "#555", textAlign: "right", marginTop: 1 }}>
        {Math.max(0, pet.hp)}/{pet.maxHp}
      </div>

      {/* EP Bar */}
      <div style={{ display: "flex", alignItems: "center", gap: 3, marginTop: 2 }}>
        <span style={{ fontFamily: "monospace", fontSize: 13, color: "#555", fontWeight: 700 }}>EP</span>
        <div style={{

...
const GAME_ITEMS = [
  ...
  { key: "exp_potion_s", name: "EXP Potion (S)", description: "A small vial of experience essence. Instantly grants +100 EXP.", category: "consumable", rarity: "common", price: 50, icon: "🧪", stat_bonus: { experience: 100 } },
  { key: "exp_potion_m", name: "EXP Potion (M)", description: "A concentrated brew of experience. Instantly grants +300 EXP.", category: "consumable", rarity: "uncommon", price: 120, icon: "🧪", stat_bonus: { experience: 300 } },
  { key: "exp_potion_l", name: "EXP Potion (L)", description: "A rare elixir of pure experience. Instantly grants +800 EXP.", category: "consumable", rarity: "rare", price: 280, icon: "🧬", stat_bonus: { experience: 800 } },
  { key: "energy_drink", name: "Energy Drink", description: "Fully restores your pet's energy to 100. Ready for more adventures!", category: "consumable", rarity: "common", price: 30, icon: "⚡", stat_bonus: { energy: 100 } },
  { key: "premium_feast", name: "Premium Feast", description: "A gourmet meal that removes all hunger and boosts happiness.", category: "consumable", rarity: "uncommon", price: 45, icon: "🍱", stat_bonus: { hunger: -80, happiness: 25 } },
  { key: "happiness_cake", name: "Happiness Cake", description: "A magical cake that fills your pet with joy. +40 happiness!", category: "consumable", rarity: "uncommon", price: 60, icon: "🎂", stat_bonus: { happiness: 40 } },
  { key: "bond_ring", name: "Bond Ring", description: "A mystical ring that deepens the bond with your pet. +35 bond.", category: "consumable", rarity: "rare", price: 150, icon: "💍", stat_bonus: { bond_level: 35 } },
  { key: "full_restore", name: "Full Restore", description: "Restores ALL stats to maximum. The ultimate recovery item!", category: "consumable", rarity: "epic", price: 300, icon: "💎", stat_bonus: { happiness: 100, energy: 100, hunger: -100, bond_level: 20 } },
...
export async function POST() {
  ...
  for (const item of GAME_ITEMS) {
    const result = await prisma.shopItem.upsert({
      where: { key: item.key },
      update: {
        name: item.name,
  ...
  return NextResponse.json({ seeded: results.length, items: results });
}
